...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_passport_passport_component__ = __webpack_require__("../../../../../src/app/components/passport/passport.component.ts");
...
var appRoutes = [
    ...
    { path: 'passport/:token', component: __WEBPACK_IMPORTED_MODULE_16__components_passport_passport_component__["a" /* PassportComponent */] },
    { path: 'home', component: __WEBPACK_IMPORTED_MODULE_11__components_home_home_component__["a" /* HomeComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]] },
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_16__components_passport_passport_component__["a" /* PassportComponent */]
        ],
        imports: [
...
module.exports = "<h2 class=\"page-header\">Login</h2>\n<form (submit)=\"onLoginSubmit()\">\n  <div class=\"form-group\">\n    <label>Username</label>\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"username\" name=\"username\">\n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input type=\"password\" class=\"form-control\" [(ngModel)]=\"password\" name=\"password\">\n  </div>\n  <input type=\"submit\" class=\"btn btn-primary\" value=\"Login\">\n  <a href=\"http://localhost:3000/auth/facebook\" class=\"btn btn-primary\"><span class=\"fa fa-facebook\"></span> Facebook</a>\n\n</form>"
...
var PassportComponent = (function () {
    function PassportComponent(authService, route, router) {
        ...
        this.route.params.subscribe(function (token) {
            if (token) {
                _this.authService.storeUserData(token.token, null);
                _this.router.navigate(['home']);
            }
        });
    }
